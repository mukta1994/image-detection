...
describe('match invadors with different accuracy', () => {
  it('should return no. of matches invador1 80% accuracy', () => {  
  ...
  it('should return no. of matches invador1 90% accuracy', () => {  
  ...
  it('should return no. of matches invador1 100% accuracy', () => {  
    const searchInvador = new SearchSpaceInvador(100)
    jest.spyOn(searchInvador, 'getNumOfInvadorsFound')
  ...
  it('should return no. of matches invador2 100% accuracy', () => {  
    const searchInvador = new SearchSpaceInvador(100)
    jest.spyOn(searchInvador, 'getNumOfInvadorsFound')
  ...
  describe.skip('test with small radars', () => {
    ...
    it('should return no. of matches invadorSmall 100% accuracy', () => {  
      const searchInvador = new SearchSpaceInvador(100)
      jest.spyOn(searchInvador, 'getNumOfInvadorsFound')
    ...
    it('should return no. of matches invadorSmall 95% accuracy', () => {  
